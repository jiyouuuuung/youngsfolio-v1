$(function(){
	...
	$('.new_sec_pdp .txt .benefit-title').wordBreakKeepAll({useCSSonIE: true});
	$('.new_sec_pdp .txt .feature-title').wordBreakKeepAll({useCSSonIE: true});
	$('.new_sec_pdp .txt .feature-desc').wordBreakKeepAll({useCSSonIE: true});
	$('.new_sec_pdp .txt .notice p').wordBreakKeepAll({useCSSonIE: true});
	$('.new_sec_pdp .txt_popup .pop_txt').wordBreakKeepAll({useCSSonIE: true});
	$('.new_sec_pdp .popup_wrap .popup_box00 .pop_txt .pop_desc').wordBreakKeepAll({useCSSonIE: true});
});
